...
export default function RetailerNav({ profile, notification, setNotification, showNotification, setShowNotification, onLogout }: Props) {
    ...
    <nav className="sticky top-0 z-50 flex items-center justify-between py-4 px-4 md:px-6 bg-[#006989]">
      ...
      <div className="flex gap-2 md:gap-4">
        ...
        <div className="relative">
          <button
            onClick={() => { setShowNotification(!showNotification); markNotificationsAsRead(); }}
